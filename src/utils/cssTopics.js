const cssTopics = [
  {
    head: "Css Tutorial",
    headContent:
      "CSS (Cascading Style Sheets) is a stylesheet language used to describe the presentation of a document written in HTML or XML. CSS defines how elements should be rendered on screen, paper, or in other media. It controls the layout, colors, fonts, and overall visual aesthetics of a web page. By separating the content (HTML) from its presentation (CSS), developers can create more maintainable and flexible web designs.\n\nCSS uses selectors to apply styles to specific HTML elements. Properties like color, font-size, margin, padding, and border determine the visual aspects of these elements. CSS also supports responsive design through media queries, allowing web pages to adapt to different screen sizes and devices.\n\nWith the ability to use external stylesheets, multiple web pages can share a consistent look and feel, enhancing the user experience. CSS is an essential tool for web development, ensuring that web pages are visually appealing and accessible across various platforms.",
    Topics: [
      {
        heading: "Why to Learn CSS?",
        link: "#",
        content:
          "JLearning CSS is crucial for web development as it provides control over the visual presentation of web pages, allowing for custom designs and styles. It separates content from presentation, making it easier to manage and update styles without altering the HTML structure. CSS enables responsive design, ensuring websites look good on all devices. It ensures consistency across multiple pages, improving user experience. Additionally, well-written CSS can enhance performance by reducing code complexity and load times. Overall, CSS is essential for creating visually appealing, efficient, and user-friendly websites.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS syntax consists of a set of rules. Each rule contains a selector and a declaration block. The selector points to the HTML element to style, and the declaration block contains one or more declarations separated by semicolons.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS selectors are used to select the HTML element(s) you want to style. There are several types of selectors including element, class, ID, and attribute selectors.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS comments are used to explain your code, and may help you when you edit the source code at a later date. Comments are ignored by browsers.",
        ulItems: ["Syntax: Comments are added with /* comment */."],
        Example: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS colors are specified using predefined color names, HEX, RGB, RGBA, HSL, and HSLA values.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS border properties are used to define the border around an HTML element.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS font properties define the font family, size, weight, and style of the text.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS text properties are used to format text. These properties control the appearance of text, such as alignment, decoration, transformation, and spacing.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS link properties are used to style links. Links can be styled to change color when hovered over or visited.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS list properties are used to style lists, including setting list markers and controlling the appearance of list items.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS table properties are used to style HTML tables. These properties control the appearance of table elements such as borders, padding, and alignment.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "The CSS box model is a fundamental concept that describes the rectangular boxes generated for elements in the document tree. It consists of margins, borders, padding, and the actual content.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS outline properties are used to draw a line around an element, outside the border. Outlines do not take up space and may be non-rectangular.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS units define the measurement of length. They can be absolute units or relative units.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS positioning allows you to position an element in a particular spot on a web page.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "The float property is used for positioning and formatting content. The clear property is used to control the behavior of floating elements.",
        ulItems: [
  ...
  {
    head: "CSS Rounded Corners",
    Topics: [
      {
        heading: "CSS Rounded Corners",
        link: "#",
        content:
          "CSS rounded corners are used to create rounded borders for elements.",
        ulItems: [
  ...
  {
    head: "CSS Border Images",
    Topics: [
      {
        heading: "CSS Border Images",
        link: "#",
        content:
          "CSS border images allow you to use an image as a border around an element.",
        ulItems: [
  ...
  {
    head: "CSS Color Keywords",
    Topics: [
      {
        heading: "CSS Color Keywords",
        link: "#",
        content:
          "CSS color keywords are predefined colors that can be used in CSS.",
        ulItems: [
    ...
    Topics: [
      {
        ...
        link: "#",
        content:
          "CSS web fonts allow you to use fonts that are not installed on the user's computer.",
        ulItems: [
