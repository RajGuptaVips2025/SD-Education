    ...
    <footer className="bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 text-center md:text-left">
          <p className="text-gray-600">&copy; 2023 Your Company, Inc. All rights reserved.</p>
        </div>
        <div className="mt-4 flex justify-center md:justify-start">
          <a href="#" className="text-gray-600 hover:text-gray-900 mx-2">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /></svg>
          </a>
          <a href="#" className="text-gray-600 hover:text-gray-900 mx-2">
          ...
          <a href="#" className="text-gray-600 hover:text-gray-900 mx-2">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 17.75l-6.172 3.828a2 2 0 00-.584 1.738 2 2 0 001.738-.584L12 15.5m0 2.25l6.172 3.828a2 2 0 00.584 1.738 2 2 0 001.738-.584L12 17.75m0-11.5l-6.172-3.828a2 2 0 00-.584-1.738 2 2 0 00-1.738.584L12 5.5m0-2.25l6.172-3.828a2 2 0 00.584-1.738 2 2 0 001.738.584L12 3.25" /></svg>
          </a>
          <a href="#" className="text-gray-600 hover:text-gray-900 mx-2">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.584 1.405L5 17m5-4v3m0 3h-3m2 1h-2" /></svg>
          </a>
        </div>
      </div>
    </footer>
