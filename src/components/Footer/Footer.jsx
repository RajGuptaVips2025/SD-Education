        ...
        <div className="container mx-auto px-16">
          <div className="flex flex-col gap-48 md:flex-row items-center justify-between">
            <div className="flex gap-10 flex-col md:flex-row mb-6">
              {arr.map((col, index) => (
                <div key={index} className="mb-6 md:mr-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between p-4 md:p-8">
              <div className="md:mr-10 md:ml-40 mb-8 md:mb-20 w-full md:w-auto">
                <h5 className="text-white uppercase font-bold mb-4 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row items-center">
                  <input
                    type="email"
                    className="bg-gray-800 border border-gray-700 rounded px-3 py-2 mb-4 md:mb-0 md:mr-2 w-full md:w-auto focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="border-t border-gray-700 mt-8 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-8">
              <img
                className="h-auto max-w-full md:max-w-48 mb-4 md:mb-0"
                src={LogoWhite}
                alt="logo"
              />
